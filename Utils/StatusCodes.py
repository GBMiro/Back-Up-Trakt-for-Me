...
statusMessages = {
    ...
    TRAKT_BAD_REQUEST : 'Bad Request - request could not be parsed',
    TRAKT_UNAUTHORIZED : 'Unauthorized - OAuth must be provided',
    TRAKT_FORBIDDEN : 'Forbidden - invalid API key or unapproved app',
    TRAKT_NOT_FOUND : 'Not Found - method exists, but no record found',
    ...
    TRAKT_SERVICE_UNAVAILABLE_1:'Service Unavailable - server overloaded (try again in 30s)',
    TRAKT_SERVICE_UNAVAILABLE_2:'Service Unavailable - server overloaded (try again in 30s)',
    TRAKT_SERVICE_UNAVAILABLE_3:'Service Unavailable - server overloaded (try again in 30s)',
    TRAKT_SERVICE_UNAVAILABLE_4:'Service Unavailable - Cloudflare error',
    TRAKT_SERVICE_UNAVAILABLE_5:'Service Unavailable - Cloudflare error',
    TRAKT_SERVICE_UNAVAILABLE_6:'Service Unavailable - Cloudflare error',
